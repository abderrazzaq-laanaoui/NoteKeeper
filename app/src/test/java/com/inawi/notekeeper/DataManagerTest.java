...
public class DataManagerTest {
    ...
    public void createNewNote() {
        ...
        final String text = "Test note Text";

        int newNoteId = sDataManager.createNewNote();
        NoteInfo newNote = sDataManager.getNotes().get(newNoteId);
        newNote.setCourse(course);
        newNote.setTitle(title);
        newNote.setText(text);

        NoteInfo compareNote = sDataManager.getNotes().get(newNoteId);
